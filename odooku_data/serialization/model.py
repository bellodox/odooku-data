...
from odooku_data.serialization.fields import FieldSerializer
...
from odooku_data.serialization.relations import (
    ManyToOneSerializer,
    ManyToManySerializer,
    GenericManyToOneSerializer
)

from odooku_data.ids import is_pk, is_nk, is_link
